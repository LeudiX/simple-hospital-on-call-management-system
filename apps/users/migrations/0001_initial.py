    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birth_date', models.DateField(help_text='Select your birth date', verbose_name='birthdate')),
                ('gender', models.IntegerField(choices=[(0, 'Male'), (1, 'Female')], help_text='Select your gender', verbose_name='gender')),
