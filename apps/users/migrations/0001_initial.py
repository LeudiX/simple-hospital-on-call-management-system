    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female'), ('Unsure', 'Unsure')], help_text='Select your gender', max_length=20, verbose_name='gender')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experience', models.IntegerField(blank=True, help_text="Doctor's Years of Experience", null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(50)], verbose_name='Experience')),
            ],
            options={
                'verbose_name': 'Doctor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('address', models.CharField(help_text='Your address info', max_length=125)),
